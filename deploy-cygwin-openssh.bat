...
set "PAUSES=1" || REM This toggles all but the last pause.
set "SSH_USER=cyg_server" || REM You'll never use this account. It's used by the Cygwin program only.
set "SSH_PW=towalls" || REM You will never need to enter this password. But change it anyway for security reasons.
set "SSH_PORT=29210"
